...
//        inputInvoiceBadRequest.setTax(5.99);
//        inputInvoiceBadRequest.setQuantity(4);
//        inputInvoiceBadRequest.setItemId(2);
//        inputInvoiceBadRequest.setProcessingFee(6.9);
//        inputInvoiceBadRequest.setUnit_price(5.99);
//        inputInvoiceBadRequest.setSubtotal(23.96);
//        inputInvoiceBadRequest.setTotal(3612.0);
//
...
//        invoiceTest.setTax(5.99);
//        invoiceTest.setQuantity(4);
//        invoiceTest.setItemId(1000);
//        invoiceTest.setProcessingFee(6.9);
//        invoiceTest.setUnit_price(5.99);
//        invoiceTest.setSubtotal(23.96);
//        invoiceTest.setTotal(3621.0);
//
